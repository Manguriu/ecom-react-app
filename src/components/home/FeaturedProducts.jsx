    ...
    return (
      <Fragment>
        ...
        <div className="section-title text-center mb-55">
          ...
          <Row>
          <Col className='p-1' key={1} xl={2} lg={2} md={2} sm={4} xm={6}>
            ...
            <Col className='p-1' key={1} xl={2} lg={2} md={2} sm={4} xm={6}>
            <Card className='image-box card'>
              <img className='center' src="https://images-na.ssl-images-amazon.com/images/G/01/AmazonExports/Fuji/2021/September/DashboardCards/Fuji_Dash_SmartWatch_1X._SY304_CB639922137_.jpg" />
            <Card.Body>
              <p className='product-name-on-card'> Iphone phone CX565 G5</p>
              <p className='product-price-on-card'>Price:Ksh.50000</p>
            </Card.Body>
            ...
            <Col className='p-1' key={1} xl={2} lg={2} md={2} sm={4} xm={6}>
            <Card className='image-box card'>
              <img className='center' src="https://m.media-amazon.com/images/I/61CGHv6kmWL._AC_UY218_.jpg" />
            <Card.Body>
              <p className='product-name-on-card'> Iphone phone CX565 G5</p>
              <p className='product-price-on-card'>Price:Ksh.50000</p>
            </Card.Body>
            ...
            <Col className='p-1' key={1} xl={2} lg={2} md={2} sm={4} xm={6}>
            <Card className='image-box card'>
              <img className='center' src="https://rukminim1.flixcart.com/image/200/200/kokdci80/dslr-camera/v/e/x/z-24-200mm-z5-nikon-original-imag2zuekuxgxsgg.jpeg?q=70" />
            <Card.Body>
              <p className='product-name-on-card'> Iphone phone CX565 G5</p>
              <p className='product-price-on-card'>Price:Ksh.50000</p>
            </Card.Body>
            ...
            <Col className='p-1' key={1} xl={2} lg={2} md={2} sm={4} xm={6}>
            <Card className='image-box card'>
              <img className='center' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQYipSYVWvJWlkIPfU7Q95SBXF0zBUiJ5DxEw&usqp=CAU" />
            <Card.Body>
              <p className='product-name-on-card'> Iphone phone CX565 G5</p>
              <p className='product-price-on-card'>Price:Ksh.50000</p>
            </Card.Body>
